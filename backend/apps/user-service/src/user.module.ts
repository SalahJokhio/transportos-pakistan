...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([User, Otp, LoyaltyTransaction, WalletTransaction, Dispute, Booking, Payment, Settlement, CompanyProfile, Bus, City, Banner, PlatformSetting, ComplianceDocument, AuditLog, Broadcast, SupportTicket, SupportMessage, LedgerEntry, OperatorLoan, SavedTraveler, SavedAddress, NotificationPreference, LoginHistory]),
  ],
  controllers: [AuthController, UserController, AdminController, LoyaltyController, WalletController, DisputesController, CatalogController, SupportController, LendingController, ProfileExtrasController, SecurityController],
  providers: [AuthService, UserService, AdminService, SettlementService, CompanyService, CatalogService, ComplianceService, AuditService, AuditInterceptor, BroadcastService, SupportService, PlatformOpsService, LedgerService, LendingService, LoyaltyService, WalletService, DisputeService, ProfileExtrasService, SecurityService, JwtStrategy],
